...
G_PLAYER_BB = {mins={x=-G_PLAYER_BB_SCALE*G_PLAYER_BB_FATNESS*0.2, y=-G_PLAYER_BB_SCALE*G_PLAYER_BB_FATNESS*0.2, z=-0.4*G_PLAYER_BB_SCALE},
			   maxs={x=G_PLAYER_BB_SCALE*G_PLAYER_BB_FATNESS*0.2, y=G_PLAYER_BB_SCALE*G_PLAYER_BB_FATNESS*0.2, z=0.4*G_PLAYER_BB_SCALE}}
